...
- [x] One clearly named deployable PlainLanguageCheck
- [x] Concrete GenVM runner hash; no floating dependency
- [x] Bounded inputs and bounded collections
- [x] Versioned policy schema: plain-language-check/policy/v2
...
Repository URL: https://github.com/El28231/plain-language-check

StudioNet contract: 0x6D98b79755d16D87a914df2838c7441c6c753D12
